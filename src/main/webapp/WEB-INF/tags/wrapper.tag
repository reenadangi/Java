...
<meta name="google-signin-client_id" content="836787780852-7mthov4o51ukrt8kutceob8odk918c2p.apps.googleusercontent.com">
...
<nav id="navbar-example2" class="navbar navbar-light bg-dark">
		...
		<a class="navbar-brand text-warning" href="/events">EventByte</a>
		
		<ul class="nav nav-pills">
		
			<li class="nav-item"><a class="nav-link" href="/events">Home</a></li>
			<li class="nav-item"><a class="nav-link" href="/logout">Logout</a></li>
			<li class="nav-item"> <button onclick="myFunction()">Click me</button></li>
